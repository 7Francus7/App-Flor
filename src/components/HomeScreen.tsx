...
export default function HomeScreen({ onGoToClients, onGoToAdd, onGoToHistory, onClientSelect }: {
  ...
  const recentRecords = getRecentRecords(10).filter((record) => record.category === activeCategory && getClient(record.clientId)).slice(0, 8);
      ...
      <div className="home-layout">
        ...
        <div className="home-left">
          ...
          <div className="stats-grid" style={{ display: 'grid', gap: 12, marginBottom: 24 }}>
            <div className="ios-card" style={{ padding: '20px', cursor: 'pointer' }} onClick={onGoToClients}>
              ...
              <p style={{ fontSize: 32, fontWeight: 700, letterSpacing: '-0.03em', color: 'var(--text-primary)', lineHeight: 1 }}>
                {clients.length}
              </p>
            ...
            <div className="ios-card" style={{ padding: '20px', cursor: 'pointer' }} onClick={onGoToHistory}>
              <div style={{ marginBottom: 12 }}>
                <div style={{
                  width: 40, height: 40, borderRadius: 12,
          ...
          {/* Quick Action */}
          <button className="ios-btn-primary" onClick={onGoToAdd} id="btn-quick-add">
